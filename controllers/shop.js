...
const stripe = require('stripe')(
  'sk_test_51KmG6sSHjP23AHqF6b6oRddhX37BziHJGLO0WLdbALq3EB7NOeaQ7qIIR4BZlAZ90qOjxc740DuuHT7H3OTqSJtj00fAgKZtTl'
);
...
module.exports.getCheckout = (req, res, next) => {
  ...
  req.user
    ...
    .then((user) => {
      ...
      const cancelUrl =
        req.protocol + '://' + req.get('host') + '/checkout/cancel'; // => http://localhost:3000/checkout/cancel
